<template>
  <view class="register">
    ...
    <u-select v-model="showDeptClass"
              :safe-area-inset-bottom="true"
              :mask-close-able="false"
              :list="deptClassList"
              title="请选择班级"
              @cancel="cancelChoose"
              @confirm="chooseDeptClass"
    ...
    <view class="content">
      ...
      <view class="main">
        ...
        <wInput v-model="Password"
                ...
                placeholder="密码"
                isShowPass></wInput>
        <wInput v-model="StuName"
                type="text"
                maxlength="11"
                placeholder="姓名"></wInput>

        <wInput v-model="Telphone"
                type="text"
                maxlength="11"
                placeholder="手机号"></wInput>
        <wInput v-model="IdCard"
                type="text"
                placeholder="身份证号码"></wInput>
      </view>
